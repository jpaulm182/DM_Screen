...
- Writes each group to a helper module (e.g., combat_tracker_panel_ui.py, combat_tracker_panel_handlers.py).
...
HELPER_PREFIXES = ["_setup_", "_handle_", "_update_", "_sort_", "_quick_", "_next_", "_add_", "_remove_", "_clear_", "_reset_", "_show_", "_toggle_", "_roll_", "_restart_", "_round_", "_check_", "_ensure_"]
